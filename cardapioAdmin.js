...
escutarProdutos(db, produtos => {
    ...
    listaProdutosEl.querySelectorAll("[data-editar-produto]").forEach(btn => {
        btn.addEventListener("click", () => {
            ...
            document.getElementById("prod-preco").value = p.precoOriginal ?? p.preco;
            document.getElementById("prod-preco-promo").value = p.precoPromocional ?? "";
...
document.getElementById("prod-salvar").addEventListener("click", async () => {
    ...
    const dados = {
        ...
        precoPromocional: document.getElementById("prod-preco-promo").value,
